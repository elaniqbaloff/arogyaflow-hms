...
import { pricing, billableItems, procedurePlans, attachments, treatmentPlans, progressNotes, tasks, approvals, audit, snapshots } from './workflowSeed'
...
export const buildInitialState = () => ({
  ...
  bills,
  pricing, billableItems, procedurePlans, attachments, treatmentPlans, progressNotes, tasks, approvals, audit, snapshots,
  clinicalTerms,
