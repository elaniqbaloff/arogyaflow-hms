...
export const departments = [
  ...
  { id: 'dep_dental', name: 'Dental', type: 'modern', head: 'doc_dental', code: 'DENT', category: 'modern', color: 'sky', icon: 'Smile', appointmentTypes: ['Consultation', 'Follow-up', 'Procedure'], consultationTemplate: 'dental', active: true, dictionaryScopes: ['dental-term', 'dental-procedure', 'symptoms'] },
  { id: 'dep_physio', name: 'Physiotherapy', type: 'support', head: 'doc_physio', code: 'PHYS', category: 'allied', color: 'gold', icon: 'Activity', appointmentTypes: ['Assessment', 'Session', 'Follow-up'], consultationTemplate: 'physio-assessment', active: true, dictionaryScopes: ['physio-term', 'physio-assessment-phrase', 'symptoms'] },
...
import { pricing, billableItems, procedurePlans, attachments, treatmentPlans, progressNotes, packages, tasks, approvals, audit, snapshots } from './workflowSeed'
...
export const buildInitialState = () => ({
  ...
  bills,
  pricing, billableItems, procedurePlans, attachments, treatmentPlans, progressNotes, packages, tasks, approvals, audit, snapshots,
  clinicalTerms,
